...
Photon::Photon(float x,float y,b2World * world,Texture * texture)
	:ParticleSystem(x,y,10.0f,0.0f,20.0f,texture,10,0),world(world)
{
	collapsed = false;
	setup(x,y);
}
...
void Photon::setup(float x,float y)
{
